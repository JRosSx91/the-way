        ...
        pagButtons.forEach((el) => {
          el.addEventListener("click", function () {
            if (!isAnimating) {
              ...
              let nextImageUniform = mat.uniforms.nextImage as THREE.Uniform & {
                value: THREE.Texture;
              };
              ...
              gsap.to(mat.uniforms.dispFactor, {
                ...
                onComplete: function () {
                  ...
                  (mat.uniforms.nextImage.value as THREE.Texture).needsUpdate =
                    true;
              ...
              gsap.fromTo(
                ...
                },
                {
                  ...
                  ease: "Expo.easeIn",
                  onComplete: function () {
                    let slideTitleEl = document.getElementById("slide-status");
                    if (slideTitleEl) {
